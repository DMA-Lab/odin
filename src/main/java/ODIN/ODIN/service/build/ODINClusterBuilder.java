...
public class ODINClusterBuilder {
     ...
     * @return cluster
     */
    public static ODINCluster build(String clusterName, boolean leaf) throws InterruptedException {
    ...
    private static void buildNonleafCluster(ODINCluster cluster) throws InterruptedException {
        GlobalVariable.NotLeaf++;
